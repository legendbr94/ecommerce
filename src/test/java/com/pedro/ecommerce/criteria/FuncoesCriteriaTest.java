...
public class FuncoesCriteriaTest extends EntityManagerTest {
    ...
    public void aplicarFuncaoNativas() {
        ...
        criteriaQuery.multiselect(
                root.get(Pedido_.id),
                criteriaBuilder.function("to_char", String.class, root.get(Pedido_.dataCriacao), criteriaBuilder.literal("Day"))
        );

        criteriaQuery.where(criteriaBuilder.equal(
                criteriaBuilder.function(
                        "acima_media_faturamento", Boolean.class, root.get(Pedido_.total)), 1)
        );
    ...
    public void aplicarFuncaoString() {
        ...
        //Todos clientes que começam com a letra T
        criteriaQuery.where(criteriaBuilder.equal(
                criteriaBuilder.substring(root.get(Cliente_.nome), 1, 1), "T"));
