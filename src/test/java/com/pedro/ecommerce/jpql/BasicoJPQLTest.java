...
public class BasicoJPQLTest extends EntityManagerTest {
    ...
    public void ordenarResultados(){
        String jpql = "select c from Cliente c order by c.id asc";//desc
    ...
    public void projetarNoDTO(){
        String jpql = "select new com.pedro.ecommerce.dto.ProdutoDTO(id, nome) from Produto";
...
//        Assert.assertFalse(lista.isEmpty());
    ...
    public void mostrarDiferencaQueries() {
        ...
        //TypedQuery não é necessário Fazer o "cast"
        ...
        //Query é necessário Fazer o uso do "cast"
